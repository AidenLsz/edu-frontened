<template>
  <div style="margin: 40px 5vw">
    ...
    <el-row type="flex" justify="start" style="margin-top:30px">
      <label style="font-weight: bold; line-height: 40px; ">请选择科目信息：</label>
      <el-select
        v-model="paper_type"
        placeholder="请选择"
        style="width: 180px; line-height: 40px"  >
        <el-option
          v-for="(item,i) in Subject_List"
          :key="i"
          :label="item.label"
          :value="item.val">
        </el-option>
      </el-select>
      <label style="font-weight: bold; line-height: 40px; padding-left: 30px" >请选择学段信息：</label>
    ...
    <el-row type="flex" justify="start" v-if="paper_type !== ''">
      <el-col :span="24" v-if="paper_type != '1' ">
      ...
      <el-col :span="24" v-if="paper_type == '1'">
        <el-row type="flex" justify="start" style="line-height: 40px">
          ...
          <p class="file-name">名称：{{mathPaperName}}</p>
        </el-row>
      </el-col>
      <el-col :span="24" v-if="paper_type == '1' && math_input == 'combine'">
        <el-row type="flex" justify="start" style="line-height: 40px">
          <div class="btn_file">
            <p style="display: inline-block">
    ...
    <el-row v-if="!pdfURL">
              ...
              <el-col :span="2" style="text-align: left" >
                <el-popover
                  ...
                  <el-button
                    slot="reference"
                    circle size="medium"
                    @click="Question_Check.splice(Question_Index, 1, false)"><i class="el-icon-edit"></i></el-button>
                </el-popover>
              </el-col>
          ...
          <div :ref="'MathDom_'+Question_Index">
              <el-row type="flex" justify="start" style="margin: 20px 5px;" >
                ...
                <div style="padding-top: 7px;padding-left:10px;">
                  <el-row type="flex" justify="start">
                    <Mathdown :content="Get_Question_Show(Question_Info.question_stem, 'stem', Question_Index)" style="" :name="Get_Name(Question_Index, 'stem')"/>
                  </el-row>
                  <el-row type="flex" justify="start">
                    <ComplexInput
              ...
              <el-row type="flex" justify="start" style="margin: 20px 5px;"
                ...
                <div style="padding-top: 7px; padding-left: 10px">
                  <el-row type="flex" justify="start">
                    <Mathdown :content="Get_Sub_Question(Sub_Question, Question_Index, Sub_Question_Index)" style="" :name="Get_Name(Question_Index, 'sub_question', Sub_Question_Index)"/>
                  </el-row>
                  <el-row type="flex" justify="start">
                    <ComplexInput
              ...
              <!-- 选项部分 -->
              <el-row type="flex" justify="start" style="margin: 7px 5px"
                ...
                <div style="padding-top: 7px; padding-left: 20px">
                  <el-row type="flex" justify="start">
                    <Mathdown :content="Get_Question_Options(Question_Option, Option_Index, Question_Index)" style=""  :name="Get_Name(Question_Index, 'option', Option_Index)"/>
                  </el-row>
                  <el-row type="flex" justify="start">
                    <ComplexInput
              ...
              <!-- 答案部分 -->
              <el-row type="flex" justify="start" style="margin: 15px 5px" v-for="(Answer, Answer_Index) in Question_Info.answer" :key="Question_Index + 'Answer_' + Answer_Index">
                 <div v-if="Question_Check[Question_Index] == false">
                   <el-row type="flex" justify="start">
                 ...
                 <div style="padding-top: 7px; padding-left: 10px">
                   <el-row type="flex" justify="start">
                    <Mathdown :content="Get_Question_Show(Answer, 'answer', Question_Index, Answer_Index)" style=""  :name="Get_Name(Question_Index, 'answer', Answer_Index)"/>
                   </el-row>
                   <el-row type="flex" justify="start">
                    <ComplexInput
              ...
              <!-- 解析部分 -->
              <el-row type="flex" justify="start" style="margin: 15px 5px">
                <div v-if="Question_Check[Question_Index] == false">
                  <el-row type="flex" justify="start">
                ...
                <div style="padding-top: 7px; padding-left: 10px">
                  <el-row type="flex" justify="start">
                    <Mathdown :content="Get_Question_Show(Question_Info.analysis, 'analyse', Question_Index)" style=""  :name="Get_Name(Question_Index, 'analyse')"/>
                  </el-row>
                  <el-row type="flex" justify="start">
                    <ComplexInput
      ...
      <el-col class="separate-part" :span="12" style="background: #F8FBFF;" >
  ...
  methods: {
    ...
    ToTop(){
      ...
      if(sessionStorage.getItem("InputPaperCache")){
        ...
        this.SubjectType = sessionStorage.getItem("InputPaperSubjectCache");
        this.PeriodType = sessionStorage.getItem("InputPaperPeriodCache");
      }
    },
    // 切换题包是否展开
    Expand_Type_Change(){
    ...
    Mix_Char_Check(val){
      ...
      for(var len = 0; len < Check_Now_List.length; len++){
        ...
        if(result[1])
          val.sub_questions.splice(len, 1, result[0])
      }
