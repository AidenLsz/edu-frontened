<template>
  <div style="margin-top: 5vh">
    ...
    <el-row>
      <el-col :span="12" style="padding-bottom: 50px; margin-top: 30px">
      ...
      <el-col :span="12" style="background: #F8FBFF; padding-top: 40px; min-height: 78vh; margin-top: 30px; padding-bottom: 40px;">
