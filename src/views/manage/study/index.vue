<template>
  <div class="exercise" style="padding-left: 5vw;margin-bottom: 40px; margin-top: 5vh">
    <!-- header -->
    ...
    <el-row>
        ...
        <el-col :span="2" :offset="14" style="padding-left: 10px">
          <el-button  style="float:right;margin-bottom:1vh" plain value="提交" @click="submit">
            <span style="font-weight: bold">录入</span>
          </el-button>
        </el-col>
    </el-row>
    ...
    <!-- <el-col :span="20" :offset="2" style="margin-bottom: 20px"> -->
      ...
      >
        ...
        <el-table-column
            prop="type"
            label="资源类型"
            :filters="[{text: '教材', value: '0'}, {text: '课件', value: '1'}, {text: '教案', value: '2'}, {text: '学案', value: '4'}]"
