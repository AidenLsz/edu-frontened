		...
		<div class="panel">
			...
			<el-row style="padding: 4vh 5vw 0 5vw" :gutter="20">
				<el-col :span="12" style="height: 500px;">
					...
					<Dialogue style="height:100%; width:100%;" :optional_image="optional_image_left"
						@Update_CI="UCI_Left"></Dialogue>
				</el-col>
				...
				<el-col :span="12" style="height: 500px;">
					...
					<Dialogue style="height:100%; width:100%;" :optional_image="optional_image_right"
						@Update_CI="UCI_Right"></Dialogue>
				</el-col>
			</el-row>

			<el-row style="padding: 4vh 5vw 0 5vw" type="flex" justify="start" :gutter="20">
				<el-col :span="2">
					<el-button type="primary" value="提交" @click="submit" :disabled="DisableCheck()">评估</el-button>
				</el-col>
				...
				<el-col :span="6">
					<el-card v-if="show_result" style="background: #a7cdff">
						...
						<div style="text-align:left;">
							<el-tag style="background: #a7cdff; border: 0px; color: #2c07ff; font-size: 14px"
								v-for="(item, index) in similarity_result" :key="index" effect="plain" id="tag">
								{{ item }}
							</el-tag>
						</div>
					</el-card>
					...
					<el-row type="flex" justify="start" class="content">
						<el-col>
							<ul>
								...
								<li>
									<p>API URL: https://kg-edu-backend-44-production.env.bdaa.pro/v1/api/similarity
									</p>
								</li>
								<li>
									<p>接口类型：POST</p>
...
<script>
	...
	export default {
		...
		methods: {
			...
			DisableCheck() {
				if (this.content_1 != "" && this.content_1 != "识别中..." && this.content_2 != "" && this.content_2 !=
					"识别中...")
					return false;
				else
					return true;
