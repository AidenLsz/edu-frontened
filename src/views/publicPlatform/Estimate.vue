		...
		<div class="panel">
			...
			<el-row style="padding-top: 4vh; padding-left: 5vw">
				<el-col :span="4">
					<el-select v-model="subject_id" placeholder="请先在此选择学科">
						<el-option v-for="subject in options" :key="subject.value_id" :label="subject.label"
				...
				<el-col :span="4" :offset="1">
					<el-select v-model="type_id" placeholder="选择学科后选择题型" :disabled="subject_id == ''">
						<el-option v-for="type in type_options" :key="type.value_id" :label="type.label"
							:value="type.value_id">
						</el-option>
					</el-select>
				</el-col>
				<el-col :span="2" :offset="1">
					<el-button type="primary" value="提交" @click="submit" :disabled="Estimate_Check()">评估
					</el-button>
				</el-col>
			...
			<div id="main">
				...
				<div id="exercise">
					...
					<Dialogue style="height:100%; width:100%;" :optional_image="optional_image" @Update_CI="UCI">
					</Dialogue>
				</div>
										...
										<div style="text-align:left;" v-if="subject_id == '数学'">
											<el-tag style="background: #a7cdff" v-for="(item, index) in kp_result"
												...
												<el-badge :hidden="kp_priority.indexOf(item) == -1"
													:value="kp_priority.indexOf(item) + 1" class="kp_badge">
													{{ item }}
												</el-badge>
											</el-tag>
										</div>
				...
				<div class="intro">
					...
					<el-row type="flex" justify="start" class="content">
						<el-col>
							<ul>
								<li>
									<p>URL: https://math-difficulty-prediction-78-production.env.bdaa.pro/v2</p>
								</li>
								<li>
									<p>接口类型: POST请求</p>
								</li>
