  ...
  methods: {
    ...
    difficulty_Change(difficultyIndex){
        ...
        if(difficultyIndex > 0){
            this.filterRecord.difficulty.splice(0, 2, variable.Difficulty[Difficulty_List[difficultyIndex-1]].min, variable.Difficulty[Difficulty_List[difficultyIndex-1]].max)
        }else{
