<template>
  ...
  >
    <div
      class="pa-spinner"
      v-show="File_Uploading || Analysing"
    ...
    <el-row type="flex" justify="start" style="margin-top: 6vh; ">
      <el-col :span="12" @click.native="Reset_Focus()">
        ...
        <el-row type="flex" justify="start" style="margin-top: 7vh; margin-bottom: -1vh">
          <el-col :span="6">
            <el-row type="flex" justify="start">
              <el-button type="primary" @click="Submit()">分析当前试卷</el-button>
            </el-row>
          </el-col>
          <el-col :span="4">
            <el-row type="flex" justify="start">
              <input type="file" accept=".doc, .docx" id="fileSelect" :multiple="false" style="display: none">
              <el-button type="primary" style="width: 100px;" @click="File_Import()" disabled>文件导入</el-button>
            </el-row>
          </el-col>
          <el-col :span="13" v-show="File_Name != ''" style="margin-bottom: 10px">
    ...
    // 返回试题类别按钮样式
      ...
      Submit(){
        ...
        if (this.Question_Bundle.length === 0) {
            this.$message.error('试题包为空，请先录入题目');
            this.Analysing = false;
            return;
        }
        ...
        for(let i = 0; i < this.Question_Bundle.length; i++){
          ...
          let Item = this.Question_Bundle[i];
          ...
          for(let j = 0; j < Item.list.length; j++){
            ...
            let Submit_JSON = Item.list[j]

            let Question_Show_Infos = {
              id: "",
              type: this.Type,
              score: 0,
              stem: Submit_JSON.stem,
              options: Submit_JSON.options,
              answer: Submit_JSON.answer,
              analysis: Submit_JSON.analysis
            }
            ...
            for(let i = 0; i < Submit_JSON.sub_questions.length; i++){
              let Sub_Now = Submit_JSON.sub_questions[i]
              for(let j = 0; j < Submit_JSON.sub_questions_image[i].length; j++){
                Sub_Now = Sub_Now + "<img src='" + Submit_JSON.sub_questions_image[i][j] + "'>"
              }
            ...
            Bundle_Format.content.push(Question_Show_Infos)
        ...
        // let file = new File(
        //   [JSON.stringify(Analyse_Paper_JSON, null, 4)],
        //   "Paper_Data.json",
