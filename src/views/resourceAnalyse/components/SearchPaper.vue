<template>
  ...
  >
    ...
    >
      ...
      ></ComplexInput>
      <el-button type="success" plain @click="simpleInput = false"
        >完成输入</el-button
      >
    </el-dialog>
    <!-- 地址框 -->
    ...
    <el-row style="padding-top: 8px; height: 40px">
      <el-col
        :span="4"
        style="text-align: left; line-height: 30px; margin-left: 5vw"
      >
        请选择要查询的数据库：
      </el-col>
    ...
    >
      ...
      <el-col :span="3">
        <el-popover placement="bottom-start" width="850" trigger="hover">
          ...
          <el-button slot="reference" class="FilterButton" type="text">{{
            Get_Subject()
          }}</el-button>
          <el-button
            slot="reference"
            type="text"
            v-if="Subject_Type.length > 0"
            @click="
              Subject_Type = [];
              submit();
            "
      ...
      <el-col :span="3">
        <el-popover placement="bottom-start" width="510" trigger="hover">
    ...
    >
      <el-row
        type="flex"
        justify="start"
        style="margin-left: 5vw; padding-left: 16px; font-size: 16px"
      >
        ...
        <el-col :span="17" class="quesCard">
          ...
          >
            <el-col style="padding-bottom: 15px">
              <Mathdown
                :content="Paper_Ques_List[Paper_Index].stem"
                :name="'P_' + Paper_Index + '_Stem'"
              ></Mathdown>
            </el-col>
            <el-col
              v-for="(Option, Option_Index) in Paper_Ques_List[Paper_Index]
                .options"
              :key="'Option_' + Option_Index + '_Of_' + Paper_Index"
            >
              <el-row style="line-height: 40px" type="flex" justify="start"
                ...
                ><Mathdown
                  style="width: 700px"
                  :content="Option"
                  :name="'Q_' + Paper_Index + '_Option_' + Option_Index"
                ></Mathdown
              ></el-row>
            </el-col>
          </el-row>
          <el-row style="margin-bottom: 15px">
            ...
            <el-col
              :span="3"
              style="line-height: 40px; color: #888; font-size: 1.5rem"
            >
            ...
            <el-col :span="4" :offset="2" style="line-height: 40px">
              <el-button
                ...
                round
                type="primary"
                @click="Paper_Detail_Show(Paper_Index)"
                >试卷详情</el-button
              >
            </el-col>
...
export default {
  ...
  data() {
    return {
      ...
      // 试题文本
      raw_text:
        "试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本试题文本",
      // 题目内容
      entities_groups: {},
      entity_type: "kp2.0",
      sour: "",
  ...
  watch: {
    ...
    // chosen_paper_List(newVal) {
    //   this.$emit("Update_paper_List", newVal);
    // },
  },
  destroyed() {
  ...
  methods: {
    ...
    Get_Subject() {
      if (this.Subject_Type.length == 0) {
        ...
        return (
          this.Subject_Type[0] + "（等" + this.Subject_Type.length + "项）"
        );
      }
    },
    Get_Period() {
